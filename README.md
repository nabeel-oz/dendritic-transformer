...
![Timeline of the project's turns, coloured by whether Nabeel or Claude made each call.](docs/assets/project-arc.svg)
...
- **Full technical reports**, with every number, error bar, and threat-to-validity: [REPORT_PHASE1.md](REPORT_PHASE1.md) and [REPORT_PHASE2.md](REPORT_PHASE2.md).
